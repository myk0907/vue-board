...
<template>
  <div class="about">
    ...
    <div class="menu real_data">
      ...
      <div class="menu_item_bar">|</div>
      <div class="menu_item" id="btn_3" @click="openProject('3')">Jeju Map</div>
      <div class="menu_item_bar">|</div>
      <div class="menu_item" id="btn_2" @click="openProject('2')">WWW</div>
      <div class="menu_item_bar">|</div>
      <div class="menu_item" id="btn_1" @click="openProject('1')">해(海)봄교실</div>
    </div>
